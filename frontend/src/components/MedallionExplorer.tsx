    ...
    <div className="space-y-6 min-w-0 max-w-full overflow-hidden">
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 w-full md:w-auto">
          ...
          <select
            ...
            className={`text-xs font-mono font-bold rounded-xl px-3.5 py-2.5 outline-none transition cursor-pointer border w-full sm:w-auto max-w-full truncate ${
              isDark
          ...
          <form onSubmit={handleSearchSubmit} className="flex items-center gap-2 w-full md:w-auto">
            <div className="relative flex-1 md:w-64">
              <input
                ...
                className={`text-xs rounded-xl pl-8 pr-3 py-2.5 outline-none w-full font-mono transition border ${
                  isDark
            ...
            <button
              type="submit"
              className="px-4 py-2.5 bg-blue-600 hover:bg-blue-500 active:bg-blue-700 text-white text-xs font-bold rounded-xl transition shadow-sm shrink-0"
            >
              Buscar
            </button>
          </form>
      ...
      {selectedTable !== '__bronze_lake__' ? (
          ...
          <div className={`p-4 border-b flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 text-xs font-mono ${isDark ? 'border-[#1f2d48]' : 'border-slate-100'}`}>
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-start">
              <button
                ...
                className={`h-10 px-3.5 rounded-xl border text-xs font-bold transition flex items-center justify-center gap-1 active:scale-95 ${
                  isDark
        ...
        >
          ...
          <div className="md:hidden divide-y divide-slate-800/40 p-3 space-y-2.5">
