...
// 2. Pipeline de Datos (Git branch / data flow style)
...
// 3. Noticias & Sentimiento (Clean newspaper / feed icon)
...
// 4. Precios & Mercado (Financial trendline / stock chart)
...
// 5. Laboratorio FinBERT (NLP Text token analysis)
...
// 6. Almacén DuckDB (Columnar warehouse storage cylinders)
