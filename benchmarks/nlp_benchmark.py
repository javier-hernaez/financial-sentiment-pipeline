...
EVALUATION_CORPUS: List[Tuple[str, str, str]] = [
    ...
    (
        "Quarterly revenue exceeded market projections by 14% with strong operating cash flow expansion.",
        "bullish",
        "Earnings & Equities",
    ),
    (
        "Company reported severe margin compression and declining forward guidance amid rising debt obligations.",
        "bearish",
        "Earnings & Equities",
    ),
    (
        "Gross margins improved 350 basis points year-over-year driven by operational efficiencies.",
        "bullish",
        "Earnings & Equities",
    ),
    (
        "Operating loss widened significantly as subscriber growth stalled across all major geographical segments.",
        "bearish",
        "Earnings & Equities",
    ),
    (
        "Management reiterated full-year EPS guidance within the previously anticipated range.",
        "neutral",
        "Earnings & Equities",
    ),
    (
        "EBITDA margins remained flat at 22.4% quarter-over-quarter in line with previous quarters.",
        "neutral",
        "Earnings & Equities",
    ),
    (
        "The board authorized a massive share buyback program alongside a 20% dividend hike.",
        "bullish",
        "Earnings & Equities",
    ),
    (
        "Substantial impairment charge recorded following restructuring of non-performing assets.",
        "bearish",
        "Earnings & Equities",
    ),
    (
        "Balance sheet liquidity remains healthy with adequate cash reserves to service short-term debt.",
        "neutral",
        "Earnings & Equities",
    ),
    (
        "Free cash flow turned sharply negative due to aggressive unbudgeted capital expenditures.",
        "bearish",
        "Earnings & Equities",
    ),
    # --- Category 2: Macroeconomics & Monetary Policy (EN & ES) ---
    (
        "The central bank maintained benchmark policy rates unchanged in line with consensus projections.",
        "neutral",
        "Macroeconomics",
    ),
    (
        "Federal Reserve signals aggressive rate hikes to combat persistent headline inflation pressures.",
        "bearish",
        "Macroeconomics",
    ),
    (
        "El banco central acordó pausar el ciclo de endurecimiento monetario manteniendo las tasas estables.",
        "neutral",
        "Macroeconomics",
    ),
    (
        "El comité de política monetaria resolvió mantener estables las tasas de referencia sin alteraciones.",
        "neutral",
        "Macroeconomics",
    ),
    (
        "La inflación interanual desciende más rápido de lo previsto estimulando expectativas de estímulo.",
        "bullish",
        "Macroeconomics",
    ),
    (
        "Yield curve inversion deepens to multi-decade extremes signaling acute economic contraction risks.",
        "bearish",
        "Macroeconomics",
    ),
    (
        "Desempleo cae a mínimos históricos mientras el consumo interno muestra una resiliencia formidable.",
        "bullish",
        "Macroeconomics",
    ),
    (
        "Manufacturing PMI figures contract for the third consecutive month pointing to economic stagnation.",
        "bearish",
        "Macroeconomics",
    ),
    (
        "Los datos de comercio exterior se mantienen invariables respecto al trimestre precedente.",
        "neutral",
        "Macroeconomics",
    ),
    (
        "Severe currency devaluation triggers emergency capital controls and strict central bank limits.",
        "bearish",
        "Macroeconomics",
    ),
    # --- Category 3: Cryptocurrencies & DeFi Protocol Dynamics (EN & ES) ---
    (
        "Unprecedented spot ETF inflows drive continuous structural accumulation across major digital assets.",
        "bullish",
        "Digital Assets & DeFi",
    ),
    (
        "Bitcoin hash rate hits new all-time record as mining network security expands substantially.",
        "bullish",
        "Digital Assets & DeFi",
    ),
    (
        "Smart contract exploit drains liquidity pools causing protocol token to collapse 90%.",
        "bearish",
        "Digital Assets & DeFi",
    ),
    (
        "El volumen de negociación ha alcanzado cotas exorbitadas tras la aprobación masiva de fondos cotizados.",
        "bullish",
        "Digital Assets & DeFi",
    ),
    (
        "Fuertes liquidaciones y ventas de pánico provocan un desplome en los principales libros de órdenes.",
        "bearish",
        "Digital Assets & DeFi",
    ),
    (
        "Las reservas institucionales de Bitcoin registran un incremento sostenido consolidando soporte en máximos.",
        "bullish",
        "Digital Assets & DeFi",
    ),
    (
        "Una catástrofe crediticia sin precedentes sacude el protocolo provocando pérdidas patrimoniales severas.",
        "bearish",
        "Digital Assets & DeFi",
    ),
    (
        "Protocol total value locked (TVL) rebounds over 40% driven by new institutional staking solutions.",
        "bullish",
        "Digital Assets & DeFi",
    ),
    (
        "The token staking yield remains steady at 5.2% APY with balanced unstaking requests.",
        "neutral",
        "Digital Assets & DeFi",
    ),
    (
        "Cascade of forced long liquidations wipes out leverage across all major derivatives exchanges.",
        "bearish",
        "Digital Assets & DeFi",
    ),
    ...
    (
        "Regulatory enforcement action initiated following systemic collateral shortfall and liquidation contagion.",
        "bearish",
        "Risk & Regulation",
    ),
    (
        "Securities regulator issues formal fraud warning against major offshore trading platform.",
        "bearish",
        "Risk & Regulation",
    ),
    (
        "La fiscalía financiera abre investigación penal por manipulación de mercado y fraude contable.",
        "bearish",
        "Risk & Regulation",
    ),
    (
        "Sovereign credit rating upgraded two notches reflecting debt restructuring success.",
        "bullish",
        "Risk & Regulation",
    ),
    (
        "Tribunal de arbitraje valida la viabilidad del plan de refinanciación permitiendo evitar la quiebra.",
        "bullish",
        "Risk & Regulation",
    ),
    (
        "Standard regulatory compliance review completed with no material deficiencies identified.",
        "neutral",
        "Risk & Regulation",
    ),
    (
        "Audit report flags critical internal control deficiencies and unverifiable asset reserves.",
        "bearish",
        "Risk & Regulation",
    ),
    (
        "El regulador aprueba sin objeciones la licencia operativa para el nuevo fondo de inversión.",
        "bullish",
        "Risk & Regulation",
    ),
    (
        "Creditors agree to a debt standstill while restructuring discussions proceed normally.",
        "neutral",
        "Risk & Regulation",
    ),
    (
        "Major credit agency places debt on review for downgrade citing deteriorating cash generation.",
        "bearish",
        "Risk & Regulation",
    ),
    # --- Category 6: Complex Syntactic Concessions & Adversarial Phrasing (EN & ES) ---
    (
        "Despite temporary supply chain headwinds, strategic restructuring sparked an extraordinary profitability turnaround.",
        "bullish",
        "Complex Syntax",
    ),
    (
        "A pesar de las pérdidas iniciales, los ingresos operativos crecieron exponencialmente superando todas las previsiones.",
        "bullish",
        "Complex Syntax",
    ),
    (
        "Although top-line revenue looked promising initially, severe accounting discrepancies triggered an urgent internal audit.",
        "bearish",
        "Complex Syntax",
    ),
    (
        "La empresa logró evitar la suspensión de pagos pero los márgenes netos se mantienen deprimidos e insostenibles.",
        "bearish",
        "Complex Syntax",
    ),
    (
        "Aunque el volumen spot aumentó levemente, la cotización se mantiene estancada en el mismo nivel sin dirección.",
        "neutral",
        "Complex Syntax",
    ),
    (
        "While short-term volatility elevated, the secular structural bull thesis remains completely intact.",
        "bullish",
        "Complex Syntax",
    ),
]
...
def run_benchmark(force_mock: bool = False) -> Dict[str, any]:
    ...
    for lbl in labels:
        ...
        class_metrics[lbl] = {"precision": precision, "recall": recall, "f1": f1, "support": support}
    ...
    brier_score = (
        sum(
            (1.0 - p["confidence"]) ** 2 if p["sentiment_label"] == act else (p["confidence"]) ** 2
            for act, p in zip(ground_truth, predictions)
        )
        / total_samples
    )
...
def display_results(res: Dict[str, any]):
    ...
    summary_tbl.add_column(
        "Valor Obtenido", style="bold green" if res["accuracy"] >= 0.88 else "yellow", justify="right"
    )
